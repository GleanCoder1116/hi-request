...
/* harmony import */ var _jsonp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _download__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var _upload__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35);
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
...
const InternalRequest = (options, host) => {
  ...
  if (type === 'jsonp' || type === 'download') {
    return type === 'jsonp' ? _jsonp__WEBPACK_IMPORTED_MODULE_1__.default : _download__WEBPACK_IMPORTED_MODULE_2__.default
  }
  return (0,_axios__WEBPACK_IMPORTED_MODULE_3__.default)(
    type === 'upload'
      ? {
          url,
          method: 'post',
          ...(0,_upload__WEBPACK_IMPORTED_MODULE_4__.default)(options).options
        }
      : {
          url,
          type: 'basics',
...
HiRequest.CancelToken = () => {
  return _axios__WEBPACK_IMPORTED_MODULE_3__.axios.CancelToken
}
/**
 * 获取cookies中的值作为参数使用
 * @param key
...
HiRequest.getCookiesParam = (key) => {
  return js_cookie__WEBPACK_IMPORTED_MODULE_0___default().get(key)
}
// add jsonp
HiRequest.jsonp = _jsonp__WEBPACK_IMPORTED_MODULE_1__.default
// download
HiRequest.download = _download__WEBPACK_IMPORTED_MODULE_2__.default
// upload
...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
...
const download = (options, host) => {
  ...
  ;(0,_axios__WEBPACK_IMPORTED_MODULE_0__.default)({ ...options, url }).then(
    (res) => {
...
const axiosIns = (options) => {
  ...
  if (
    ...
    Object.assign(options, { data: qs__WEBPACK_IMPORTED_MODULE_1___default().stringify(data) })
  }
